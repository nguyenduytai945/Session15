...
<form id="locale" action="worldclock" method="get">
    <select name="city" onchange="document.getElementById('locale').submit()">
        ...
        <option value="Asia/Hue">Select a city</option>
        <option value="Asia/Hue" selected>Hue</option>
        <option value="Asia/Tokyo">Tokyo</option>
        <option value="Asia/Seoul">Seoul</option>
        <option value="Europe/London">London</option>
        <option value="Europe/Madrid">Madrid</option>
        <option value="America/New_York">New York</option>
        <option value="Australia/Thanh phuoc">Thanh phuoc</option>
        <option value="Argentina/Bao vinh">Bao vinh</option>
    </select>
</form>
</body>
</html>
